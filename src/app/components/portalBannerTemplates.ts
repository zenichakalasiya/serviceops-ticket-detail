...
export const BANNER_TEMPLATES: BannerTemplate[] = [
  /* ═════ Horizontal ═════ */
  {
    ...
    title: WHITE_TITLE, subtitle: WHITE_SUB, pad: { top: 28, bottom: 28, left: 32, right: 32 },
  ...
  },
  {
    ...
    title: { size: 30, color: INK }, subtitle: INK_SUB, pad: { top: 32, bottom: 28, left: 32, right: 22 },
  ...
  },
  {
    ...
    title: { size: 42, color: '#07101F' }, subtitle: { size: 14, color: '#6B5450' }, pad: { top: 36, bottom: 36, left: 43, right: 43 },
    text: { gap: 28 },
    pieces: [{ key: 'text' }],
    tree: 'text',
    page: { heroInk: 'dark' },
  },
  {
    ...
    title: { size: 42, color: '#0D2C22' }, subtitle: { size: 14, color: '#4C6459' }, pad: { top: 36, bottom: 36, left: 43, right: 43 },
    text: { gap: 28 },
    pieces: [{ key: 'text' }],
    tree: 'text',
    page: { heroInk: 'dark' },
  },
  {
    ...
    title: { size: 32, color: '#FFFFFF' }, subtitle: WHITE_SUB, pad: { top: 28, bottom: 28, left: 32, right: 22 },
  ...
  },
  {
    ...
    title: { size: 32, color: INK }, subtitle: INK_SUB, pad: { top: 28, bottom: 28, left: 32, right: 32 },
  ...
  },
  {
    ...
    title: { size: 38, color: '#07101F' }, subtitle: { size: 14, color: '#4F5B6D' }, pad: { top: 32, bottom: 32, left: 43, right: 32 },
  ...
  },
  {
    ...
    title: { size: 36, color: INK }, subtitle: INK_SUB, pad: { top: 32, bottom: 32, left: 43, right: 32 },
  ...
  },
  {
    ...
    title: { size: 30, color: INK }, subtitle: INK_SUB, pad: { top: 28, bottom: 28, left: 32, right: 32 },
    sectionGap: { x: 40, y: 24 },
  ...
  },
  {
    ...
    title: { size: 20, color: INK }, subtitle: { size: 13, color: '#4F5B6D' }, pad: { top: 20, bottom: 20, left: 22, right: 22 },
  ...
  },
  {
    ...
    title: { size: 22, color: INK }, subtitle: { size: 13, color: '#4F5B6D' }, pad: { top: 20, bottom: 20, left: 22, right: 22 },
  ...
  },
  {
    ...
    title: { size: 22, color: '#FFFFFF' }, subtitle: { size: 13, color: 'rgba(255,255,255,0.7)' }, pad: { top: 24, bottom: 28, left: 32, right: 32 },
  ...
  },
  {
    ...
    title: { size: 24, color: INK }, subtitle: { size: 13, color: '#4F5B6D' }, pad: { top: 24, bottom: 24, left: 22, right: 22 },
    text: { dir: 'row', align: 'stretch' },
    pieces: [{ key: 'text' }],
    tree: 'text',
    page: { heroInk: 'dark' },
  ...
  },
  {
    ...
    title: { size: 28, color: INK }, subtitle: INK_SUB, pad: { top: 24, bottom: 24, left: 22, right: 22 },
  ...
  },
  {
    ...
    title: { size: 38, color: INK }, subtitle: INK_SUB, pad: { top: 32, bottom: 32, left: 43, right: 32 },
    sectionGap: { x: 48, y: 40 },
    text: { alignY: 'stretch', gap: 40 },
  ...
  },
  {
    ...
    title: WHITE_TITLE, subtitle: { size: 15, color: 'rgba(255,255,255,0.9)' }, pad: { top: 32, bottom: 32, left: 43, right: 43 },
    text: { gap: 24 },
    pieces: [{ key: 'text' }],
    tree: 'text',
  },
  {
    ...
    title: { size: 36, color: '#FFFFFF' }, subtitle: WHITE_SUB, pad: { top: 32, bottom: 28, left: 32, right: 32 },
  ...
  },
  {
    ...
    title: { size: 32, color: '#FFFFFF' }, subtitle: WHITE_SUB, pad: { top: 32, bottom: 32, left: 32, right: 32 },
    text: { gap: 24 },
    pieces: [{ key: 'text' }],
    tree: 'text',
  },
  ...
  },
  {
    ...
    title: { size: 30, color: '#1F2937' }, subtitle: { size: 13, color: '#6B7280' }, pad: { top: 28, bottom: 28, left: 32, right: 32 },
    sectionGap: { x: 16, y: 20 },
  ...
  },
  {
    ...
    title: { size: 30, color: '#FFFFFF' }, subtitle: WHITE_SUB, pad: { top: 24, bottom: 24, left: 32, right: 32 },
  ...
  },
  {
    ...
    title: { size: 34, color: '#FFFFFF' }, subtitle: WHITE_SUB, pad: { top: 28, bottom: 28, left: 32, right: 0 },
    sectionGap: { x: 32, y: 24 },
  ...
  },
  {
    ...
    title: { size: 28, color: '#FFFFFF' }, subtitle: WHITE_SUB, pad: { top: 24, bottom: 24, left: 32, right: 22 },
    sectionGap: { x: 24, y: 20 },
    pieces: [{ key: 'text' }, announcements('image')],
    tree: R('text', 'ann'),
  },
